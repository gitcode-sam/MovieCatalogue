...
class Movie:
	def __init__(self, root):
		...
		#Fuctions
		def iExit():
			iExit=tkinter.messagebox.askyesno("Online Movie catalogue", "Are you sure???")
			if iExit>0:
				root.destroy()
			return
		...
		self.TFrame=Label(TFrame, font=('Arial', 48, 'bold'), text="ONLINE MOVIE CATALOGUE", bg="black", fg="yellow")
		self.TFrame.grid() 
		...
		self.lblMovie_ID=Label(DFrameL, font=('Arial', 18, 'bold'), text="Movie ID:", padx=2, pady=2, bg="black", fg="white")
		...
		self.lblMovie_Name=Label(DFrameL, font=('Arial', 18, 'bold'), text="Movie Name:", padx=2, pady=2, bg="black", fg="white")
		...
		self.lblRelease_Date=Label(DFrameL, font=('Arial', 18, 'bold'), text="Release Date:", padx=2, pady=2, bg="black", fg="white")
		...
		self.lblDirector=Label(DFrameL, font=('Arial', 18, 'bold'), text="Director:", padx=2, pady=2, bg="black", fg="white")
		...
		self.lblCast=Label(DFrameL, font=('Arial', 18, 'bold'), text="Cast:", padx=2, pady=2, bg="black", fg="white")
		...
		self.lblBudget=Label(DFrameL, font=('Arial', 18, 'bold'), text="Budget (Crores INR):", padx=2, pady=2, bg="black", fg="white")
		...
		self.lblDuration=Label(DFrameL, font=('Arial', 18, 'bold'), text="Duration (Hrs):", padx=2, pady=2, bg="black", fg="white")
		...
		self.lblRating=Label(DFrameL, font=('Arial', 18, 'bold'), text="Rating (Out of 5):", padx=2, pady=2, bg="black", fg="white")
		...
		MovieList=Listbox(DFrameR, width=41, height=16, font=('Arial', 12, 'bold'), bg="black", fg="yellow", yscrollcommand=sb.set)
		...
		self.btnse=Button(BFrame, text="Search", font=('Arial', 20, 'bold'), width=10, height=1, bd=4, bg="white", command=searchdb)
